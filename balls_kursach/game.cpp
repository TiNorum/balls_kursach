...
TTF_Font* FONT_DYNAMIC_M;
TTF_Font* FONT_DYNAMIC_L;
...
void gameEndDialog()
{
	...
	SDL_SetRenderDrawColor(renderer, 71, 116, 157, 100);
...
void init_game_field( )
{
	...
	FONT_DYNAMIC_M = TTF_OpenFont("Font.TTF", 44);
	FONT_DYNAMIC_L = TTF_OpenFont("Font.TTF", 80);
...
//проверяем на то, что все ячейки будут пусты
bool checkGameEnd()
{
